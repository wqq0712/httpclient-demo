...
public class HttpClientUtil {
	...
	static {
		try {
			client4HTTP = HCBuilder.custom().build();
			client4HTTPS = HCBuilder.custom().ssl().build();
	 ...
	 */
	private static void create(HttpConfigBuilder config) throws HttpProcessException {
	...
	public static String get(HttpClient client, String url, Header[] headers, HttpContext context, String encoding)
			throws HttpProcessException {
		return get(HttpConfigBuilder.custom().client(client).url(url).headers(headers).context(context)
				.encoding(encoding));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String get(HttpConfigBuilder config) throws HttpProcessException {
	...
	public static String post(HttpClient client, String url, Header[] headers, Map<String, Object> parasMap,
		...
		return post(HttpConfigBuilder.custom().client(client).url(url).headers(headers).map(parasMap).context(context)
				.encoding(encoding));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String post(HttpConfigBuilder config) throws HttpProcessException {
	...
	public static String put(HttpClient client, String url, Map<String, Object> parasMap, Header[] headers,
			HttpContext context, String encoding) throws HttpProcessException {
		return put(HttpConfigBuilder.custom().client(client).url(url).headers(headers).map(parasMap).context(context)
				.encoding(encoding));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String put(HttpConfigBuilder config) throws HttpProcessException {
	...
	public static String delete(HttpClient client, String url, Header[] headers, HttpContext context, String encoding)
			throws HttpProcessException {
		return delete(HttpConfigBuilder.custom().client(client).url(url).headers(headers).context(context)
				.encoding(encoding));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String delete(HttpConfigBuilder config) throws HttpProcessException {
	...
	public static String patch(HttpClient client, String url, Map<String, Object> parasMap, Header[] headers,
			HttpContext context, String encoding) throws HttpProcessException {
		return patch(HttpConfigBuilder.custom().client(client).url(url).headers(headers).map(parasMap).context(context)
				.encoding(encoding));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String patch(HttpConfigBuilder config) throws HttpProcessException {
	...
	public static String head(HttpClient client, String url, Header[] headers, HttpContext context, String encoding)
			throws HttpProcessException {
		return head(HttpConfigBuilder.custom().client(client).url(url).headers(headers).context(context)
				.encoding(encoding));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String head(HttpConfigBuilder config) throws HttpProcessException {
	...
	public static String options(HttpClient client, String url, Header[] headers, HttpContext context, String encoding)
			throws HttpProcessException {
		return options(HttpConfigBuilder.custom().client(client).url(url).headers(headers).context(context)
				.encoding(encoding));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String options(HttpConfigBuilder config) throws HttpProcessException {
	...
	public static String trace(HttpClient client, String url, Header[] headers, HttpContext context, String encoding)
			throws HttpProcessException {
		return trace(HttpConfigBuilder.custom().client(client).url(url).headers(headers).context(context)
				.encoding(encoding));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String trace(HttpConfigBuilder config) throws HttpProcessException {
	...
	public static OutputStream down(HttpClient client, String url, Header[] headers, HttpContext context,
		...
		return down(HttpConfigBuilder.custom().client(client).url(url).headers(headers).context(context).out(out));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static OutputStream down(HttpConfigBuilder config) throws HttpProcessException {
	...
	public static String upload(HttpClient client, String url, Header[] headers, HttpContext context)
			throws HttpProcessException {
		return upload(HttpConfigBuilder.custom().client(client).url(url).headers(headers).context(context));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String upload(HttpConfigBuilder config) throws HttpProcessException {
	...
	public static int status(HttpClient client, String url, Header[] headers, HttpContext context, HttpMethods method)
			throws HttpProcessException {
		return status(
				HttpConfigBuilder.custom().client(client).url(url).headers(headers).context(context).method(method));
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static int status(HttpConfigBuilder config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(HttpConfigBuilder config) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	private static HttpResponse execute(HttpConfigBuilder config) throws HttpProcessException {
		create(config);// 获取链接
