...
public class HttpConfigBuilder {
	 ...
	 * @return
	 */
	public static HttpConfigBuilder custom() {
	 ...
	 * HttpClient对象
	 */
	public HttpConfigBuilder client(HttpClient client) {
		this.client = client;
		return this;
	}
	 ...
	 * 资源url
	 */
	public HttpConfigBuilder url(String url) {
		urls.set(url);
		return this;
	}
	 ...
	 * Header头信息
	 */
	public HttpConfigBuilder headers(Header[] headers) {
	 ...
	 */
	public HttpConfigBuilder headers(Header[] headers, boolean isReturnRespHeaders) {
		this.headers = headers;
	 ...
	 * 请求方法
	 */
	public HttpConfigBuilder method(HttpMethods method) {
		this.method = method;
		return this;
	}
	 ...
	 * 请求方法
	 */
	public HttpConfigBuilder methodName(String methodName) {
	 ...
	 * cookie操作相关
	 */
	public HttpConfigBuilder context(HttpContext context) {
	 ...
	 * 传递参数
	 */
	public HttpConfigBuilder map(Map<String, Object> map) {
	 ...
	 * 以json格式字符串作为参数
	 */
	public HttpConfigBuilder json(String json) {
		this.json = json;
	 ...
	 * 上传文件时用到
	 */
	public HttpConfigBuilder files(String[] filePaths) {
	 ...
	 */
	public HttpConfigBuilder files(String[] filePaths, String inputName) {
	 ...
	 * @return
	 */
	public HttpConfigBuilder files(String[] filePaths, String inputName, boolean forceRemoveContentTypeCharset) {
		synchronized (getClass()) {
			if (this.map == null) {
	 ...
	 * 输入输出编码
	 */
	public HttpConfigBuilder encoding(String encoding) {
		// 设置输入输出
		inenc(encoding);
		outenc(encoding);
	 ...
	 * 输入编码
	 */
	public HttpConfigBuilder inenc(String inenc) {
		this.inenc = inenc;
		return this;
	}
	 ...
	 * 输出编码
	 */
	public HttpConfigBuilder outenc(String outenc) {
		this.outenc = outenc;
		return this;
	}
	 ...
	 * 输出流对象
	 */
	public HttpConfigBuilder out(OutputStream out) {
		outs.set(out);
		return this;
	}
